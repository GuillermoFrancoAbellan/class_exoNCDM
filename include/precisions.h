...
//class_precision_parameter(ncdm_fluid_approximation,int,ncdmfa_none) /**< method for non-cold dark matter fluid approximation */
...
class_type_parameter(evolver,int,enum evolver_type,rk)
