...
int input_read_parameters(
  ...
  if ((flag1 == _TRUE_) && (N_ncdm > 0)){
    ...
    /* GFA: background ncdm distribution, 0 is fermi-dirac, 1 is warm dark matter. */
    class_read_list_of_integers_or_default("background_ncdm_psd",pba->background_ncdm_psd,0,N_ncdm);
